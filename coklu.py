...
def deprem_cek():
    ...
    dosya = open("C:\\Users\\Furkan\\Desktop\\Harita Haber\\Depremler\\Depremler.js","w")
...
def haber_cek():
    ...
    for sehir in sehirler:
        ...
        dosya = open("C:\\Users\\Furkan\\Desktop\\Harita Haber\\Haberler\\"+sehir+".js","w")
        dosya.write("""
        ...
        dosya.close()
        sayac=sayac+1
        print "Baþlýk = ",kaynak.title.text 
while 1:
    deprem_cek()
    haber_cek()
